...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/isurus/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/isurus/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/isurus/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/isurus/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/isurus/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/isurus/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/isurus/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/isurus/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/isurus/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/isurus/system/build.prop)
